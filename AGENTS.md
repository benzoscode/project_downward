...
| 玩家 | 16×24 | 判定 12×20 |
| 老鼠 | 27×9（idle 12 帧/run 9 帧纵向条带；跳跃上升/下降 20×20 单帧） | 判定 20×8（取身体不含尾巴；大素材保尺寸改判定，2026-08-20 用户拍板） |
| Boss | 128×128 | 约玩家 8 倍；2026-08-20 正式素材（idle4帧/move4帧/attack6帧纵向，`char_boss_*`） |
| 道具/按钮/水晶/光球 | 16×16（道具拾取物与 HUD 图标 24×24） | |
| 门 | 16×48 | 1×3 格；2026-08-20 正式石门素材（空/正确/错误三态×3变体，`assets/props/door_stone_*`） |
| 宝箱/石像 | 32×32 | |
